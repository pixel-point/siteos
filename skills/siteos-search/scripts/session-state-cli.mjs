...
const CREDENTIAL_VALUE_REGEX =
  /\b(?:pboot|porg|pui|pdel|pfs|psq|psi|sos|sos_cli)_[A-Za-z0-9_-]+\b/;

const HELP_TEXT = `SiteOS Search session-state CLI

Usage:
  node .agents/skills/siteos-search/scripts/session-state-cli.mjs <command> [options]
...
function connectionPatchFromOptions(options) {
  return compactObject({
    ...
    environmentSlug: optionalString(options, "environment-slug"),
